# Flutter News Templates API ☁️

## Getting Started 🚀

The Flutter News Templates API is written in [Dart](https://dart.dev) and uses [Dart Frog](https://verygoodopensource.github.io/dart_frog).
