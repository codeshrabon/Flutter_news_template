...
void main() {
  ...
  group('FlutterNewsTemplatesApiClient', () {
    late http.Client httpClient;
    late FlutterNewsTemplatesApiClient apiClient;
    ...
    setUp(() {
      ...
      apiClient = FlutterNewsTemplatesApiClient(
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => FlutterNewsTemplatesApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = FlutterNewsTemplatesApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test('makes correct http request (with authorization token).', () async {
        ...
        await FlutterNewsTemplatesApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
      ...
      test(
          'throws FlutterNewsTemplatesApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<FlutterNewsTemplatesApiMalformedResponse>()),
        );
      });

      test(
          'throws FlutterNewsTemplatesApiRequestFailure '
        ...
        expect(
          () => apiClient.getArticle(id: articleId),
          throwsA(
            isA<FlutterNewsTemplatesApiRequestFailure>()
