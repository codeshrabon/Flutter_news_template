...
/// {@template flutter_news_templates_api_malformed_response}
/// An exception thrown when there is a problem decoded the response body.
/// {@endtemplate}
class FlutterNewsTemplatesApiMalformedResponse implements Exception {
  /// {@macro flutter_news_templates_api_malformed_response}
  const FlutterNewsTemplatesApiMalformedResponse({required this.error});

  /// The associated error.
  final Object error;
}

/// {@template flutter_news_templates_api_request_failure}
/// An exception thrown when an http request failure occurs.
/// {@endtemplate}
class FlutterNewsTemplatesApiRequestFailure implements Exception {
  /// {@macro flutter_news_templates_api_request_failure}
  const FlutterNewsTemplatesApiRequestFailure({
...
/// {@template flutter_news_templates_api_client}
/// A Dart API client for the Flutter News Templates API.
/// {@endtemplate}
class FlutterNewsTemplatesApiClient {
  /// Create an instance of [FlutterNewsTemplatesApiClient] that integrates
  /// with the remote API.
  ///
  /// {@macro flutter_news_templates_api_client}
  FlutterNewsTemplatesApiClient({
  ...
  ///
  /// {@macro flutter_news_templates_api_client}
  FlutterNewsTemplatesApiClient.localhost({
    required TokenProvider tokenProvider,
    http.Client? httpClient,
  }) : this._(
  ...
  /// {@macro flutter_news_templates_api_client}
  FlutterNewsTemplatesApiClient._({
  ...
  Future<ArticleResponse> getArticle({
    ...
    if (response.statusCode != HttpStatus.ok) {
      throw FlutterNewsTemplatesApiRequestFailure(
        body: body,
  ...
  Map<String, dynamic> json() {
    try {
      ...
      Error.throwWithStackTrace(
        FlutterNewsTemplatesApiMalformedResponse(error: error),
        stackTrace,
      );
    }
  }
